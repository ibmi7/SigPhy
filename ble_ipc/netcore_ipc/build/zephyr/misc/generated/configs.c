...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_MTU, 492);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_ALIGN_SETTINGS_STORAGE, 0x800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_CONN, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_LOCAL_PROC_CTX_BUF_NUM, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_LLCP_REMOTE_PROC_CTX_BUF_NUM, 8);
