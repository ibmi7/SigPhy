...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_SETTINGS_STORAGE, 0x4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_SMP_WORKQUEUE_STACK_SIZE, 4608);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXAMPLE_I2C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXAMPLE_SPIM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXAMPLE_EXT_INT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXAMPLE_ADC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXAMPLE_HS_UART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXAMPLE_FLASH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COMPREHENSIVE_EXAMPLE_CONFIG_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COMPREHENSIVE_EXAMPLE_CONFIG_LOG_LEVEL, 3);
